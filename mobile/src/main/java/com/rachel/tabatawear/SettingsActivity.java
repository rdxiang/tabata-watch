...
//        startService(new Intent(com.rachel.tabatawear.))
    ...
    private void setupSimplePreferencesScreen() {
        ...
        bindPreferenceSummaryToValue(findPreference("intervals"));
        bindPreferenceSummaryToValue(findPreference("work_seconds"));
        bindPreferenceSummaryToValue(findPreference("rest_seconds"));
    }
